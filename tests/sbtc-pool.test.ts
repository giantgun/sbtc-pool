...
Note tests will fail because the testnet sbtc contract used is not supported in the simnet 
deployment plan. To test the contract correctly change the requirements to the mainnet sbtc contract
`)
